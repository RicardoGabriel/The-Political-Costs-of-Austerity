...
***********************************************************
* Variable for top si - not used so far
***********************************************************
gen sample = .
sum fracmil2, d
replace sample = 1 if fracmil2 > r(p90) & fracmil2 != .
drop if sample == 1
...
tex (10) Excluding regions in top 10\% of \$ s_i \$ & ${b_0}${star_0} & ${b_1}${star_1}  & ${b_2}${star_2} & ${b_3}${star_3} & ${b_4}${star_4}  \\
