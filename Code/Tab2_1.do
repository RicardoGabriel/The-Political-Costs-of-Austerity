...
*********************************************
local state = "lowunemp"
local low "Expansions"
local high "Recessions"
...
gen lowunemp = 0
replace lowunemp = 1 if F0pcGDP > 0 

* low and high unemployment within nuts id
gen nonemprate = (Population - Employment_Total) / Population
...
tex \multicolumn{6}{l}{\textbf{Panel A: recessions vs expansions}} \\
tex Recessions & ${b_0_high}${star_0_high} & ${b_1_high}${star_1_high}  & ${b_2_high}${star_2_high} & ${b_3_high}${star_3_high} & ${b_4_high}${star_4_high}  \\
tex	& (${se_0_high} ) & (${se_1_high} ) & (${se_2_high} ) & (${se_3_high} ) & (${se_4_high} )   \\
tex Expansions & ${b_0_low}${star_0_low} & ${b_1_low}${star_1_low}  & ${b_2_low}${star_2_low} & ${b_3_low}${star_3_low} & ${b_4_low}${star_4_low}  \\
