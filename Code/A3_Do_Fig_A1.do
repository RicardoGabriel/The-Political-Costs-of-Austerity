...
use "${hp}Data\Out\Data_Real.dta", clear
...
graph export "$Fig\dist_inst.pdf", replace
reg Alesina4_dif if Alesina4 !=0
outreg2 using $Tab\dist_table.xls, tstat bracket e(N_full) label excel bdec(2) replace
...
graph export "$Fig\dist_far.pdf", replace
reg F0Far_share_dif
outreg2 using $Tab/dist_table.xls, tstat bracket e(N_full) label excel bdec(2)
...
graph export "$Fig\dist_pcGOV.pdf", replace
reg F0pcGOV_dif
outreg2 using $Tab/dist_table.xls, tstat bracket e(N_full) label excel bdec(2)
