...
* Removing Intermediate Consumption			
...
bys Nuts0_id Year: egen Votes_Nuts0 = total(Votes)
...
tex (10) Expressing dep var to country average & ${b_0}${star_0} & ${b_1}${star_1}  & ${b_2}${star_2} & ${b_3}${star_3} & ${b_4}${star_4}  \\
