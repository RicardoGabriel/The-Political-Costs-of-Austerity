...
* Rob Check: discard observations since great recession 
drop if Year>=2008 
...
tex (3) Dropping Great Recession & ${b_0}${star_0} & ${b_1}${star_1}  & ${b_2}${star_2} & ${b_3}${star_3} & ${b_4}${star_4}  \\
