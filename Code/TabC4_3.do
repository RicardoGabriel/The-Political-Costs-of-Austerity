...
*********************************************
local state = "far_incumbent"
local low "Left"
local high "Right"

gen far_incumbent = (F0Far_Incumbent > 0)
...
texdoc init "$Tab\TableC4.tex", append force
tex \multicolumn{6}{l}{\textbf{Panel C: far party in government?}} \\
tex Yes & ${b_0_low}${star_0_low} & ${b_1_low}${star_1_low}  & ${b_2_low}${star_2_low} & ${b_3_low}${star_3_low} & ${b_4_low}${star_4_low}  \\
tex	& (${se_0_low} ) & (${se_1_low} ) & (${se_2_low} ) & (${se_3_low} ) & (${se_4_low} )   \\ \addlinespace 
tex No & ${b_0_high}${star_0_high} & ${b_1_high}${star_1_high}  & ${b_2_high}${star_2_high} & ${b_3_high}${star_3_high} & ${b_4_high}${star_4_high}  \\
